...
import { DisplayEpisodeChildrenProps } from "../../types/types";
import { useSelector } from "react-redux";
import { RootState } from "../../redux/store";

const DisplayChildrenEpisode = ({episode,showUri, firstItemRef,index, clickPlay, displayEpisode,offset}: DisplayEpisodeChildrenProps) => {   
    ...
    <div 
        ...
        <div className="episode-img">
            {index == 0 ? <img ref={firstItemRef} tabIndex={0} src={episode.img} alt="" /> : <img src={episode.img} alt="" />}
        </div>
        <div className="episode-titles">
            ...
            <svg style={{fill: "var(--clr-primary)"}} onClick={async () =>{await clickPlay(episode.uri, showUri, (Number(offset)-index))}} xmlns="http://www.w3.org/2000/svg" height="48" viewBox="0 -960 960 960" width="48"><path d="M370-320h60v-320h-60v320Zm160 0h60v-320h-60v320ZM480-80q-82 0-155-31.5t-127.5-86Q143-252 111.5-325T80-480q0-83 31.5-156t86-127Q252-817 325-848.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 82-31.5 155T763-197.5q-54 54.5-127 86T480-80Z"/></svg> 
                            
            :

            <svg onClick={async () => {               
               await clickPlay(episode.uri, showUri, (Number(offset)-index));
